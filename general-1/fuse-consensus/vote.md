...
Ubit chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://ubitscan.com/address/0xD212f646A2C5ab586038568A9cfE5BD187fDe91D) with the following params:
...
Some other useful functions on the [voting contract](https://ubitscan.com/address/0xD212f646A2C5ab586038568A9cfE5BD187fDe91D) are:
