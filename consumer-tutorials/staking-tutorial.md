---
description: This tutorial will explain how to delegate/stake/unstake your UBIT.
---

# Staking tutorial

Note: You can only stake UBIT which is on Ubit network. Please make sure you have changed into Ubit network in Metamask while doing any transactions on staking UI. 

How to Stake Ubit:

**Step 1:**

Navigate to staking.ubitscan.com and login to your wallet through metamask. Make sure you are on Ubit network. If you are not please follow the instructions [**here**](https://docs.ubitscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of UBIT you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
