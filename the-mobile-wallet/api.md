...
The Ubit Studio REST API for accessing the data and the services of the Ubit network in a simple way. You can use this API to query and interact with the objects of the Ubit network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Ubit network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Ubit\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Ubit network |
...
| homeBridgeAddress | `String` | Bridge address on the Ubit network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Ubit network |
...
Community is a set of contracts and services. Members of the community are users of the Ubit network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Ubit network |
| homeTokenAddress | `String` | Address of the community token on the Ubit network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Ubit network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Ubit network |
...
Entity is an account on the Ubit network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Ubit network |
...
Tokens are compatible with the UBIT20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
