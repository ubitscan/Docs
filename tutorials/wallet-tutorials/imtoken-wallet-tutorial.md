...
Below tutorial will help you understand how to add Ubit network RPC on imToken through chainlist.org and transfer/receive tokens on fuse network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “Ubit” on the list of EVM networks. Click on “Add to imToken” next to Ubit Mainnet and “Approve” the details of Ubit RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added Ubit network RPC on imToken wallet. You can now send/receive Ubit network assets on imToken wallet.  
